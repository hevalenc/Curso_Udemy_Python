#aula sobre Abstract Factory
"""
Abstract Factory method é um padrão de criação que fornece uma interface para criar famílias de objetos relacionados
...
Uma diferença importante entre Factory Method e Abstract Factory é que o Factory Method usa herança, enquanto Abstract
Factory usa a composição.
...
class Cliente:
    def busca_clientes(self):
        for factory in [ZonaNorteVeiculoFactory(),ZonaSulVeiculoFactory()]:
            ...
            carro_luxo = factory.get_moto_luxo()
